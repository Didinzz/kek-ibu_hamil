        ...
        <section id="definisi" className="py-16 px-6 lg:px-16 max-w-7xl mx-auto scroll-mt-20 bg-white">
            <div className="w-full">
                <motion.div custom={0} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="mb-8">
                    ...
                    <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#1E293B] mb-3 tracking-tight">Apa Itu KEK?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <motion.div custom={0.1} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="relative bg-linear-to-br from-[#FFF5F9] to-white border border-[#e71d89]/15 rounded-2xl p-6 lg:p-7 shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <motion.div custom={0.2} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="bg-white border border-slate-200 rounded-2xl p-6 lg:p-7 shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="flex items-center gap-4 mb-4">
                ...
                <motion.div custom={0.3} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="relative bg-[#FFF5F9] border border-[#e71d89]/20 rounded-2xl p-5 lg:p-6 flex flex-col md:flex-row gap-5 items-start shadow-sm">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/80 border border-[#e71d89]/15 rounded-md px-3 py-2 text-[11.5px] text-slate-600">
                            ...
                            <span>Sumber: <strong className="text-[#1E293B]">Juknis PMT Berbahan Pangan Lokal, Kemenkes RI 2025; Pedoman Pelayanan Gizi Bumil KEK, Kemenkes RI 2018</strong></span>
                        </div>
                    </div>
                </motion.div>
            </div>
