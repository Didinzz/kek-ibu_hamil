...
export default function TatalaksanaMateri() {
    ...
    const steps = [
        ...
        },
        {
            ...
            body: <>Semua ibu hamil mendapat <strong className="text-[#1E293B]">minimal 90 tablet Fe</strong> selama kehamilan. Diminum 1 tablet/hari pada malam hari sebelum tidur, disertai air jeruk atau sumber vit. C. <strong className="text-[#e71d89]">Jangan diminum bersamaan dengan teh, kopi, atau susu</strong> karena menghambat penyerapan.</>,
        ...
        },
        {
            ...
            body: <>Timbang BB setiap kunjungan ANC (minimal <strong className="text-[#1E293B]">6 kali</strong> selama kehamilan: 2× TM I, 1× TM II, 3× TM III). Kenaikan BB yang diharapkan untuk ibu KEK/Risiko KEK: <strong className="text-[#1E293B]">±0,5 kg/minggu</strong>. Ukur LILA setiap bulan untuk evaluasi respons intervensi.</>,
        ...
        },
        {
            ...
            body: <>Bila BB tidak naik adekuat atau terdapat <strong className="text-[#1E293B]">komorbiditas</strong> (anemia berat Hb &lt; 8 g/dL, penyakit penyerta, hiperemesis berat), lakukan pemeriksaan oleh dokter. Juknis 2025 menyebut: <strong className="text-[#1E293B]">KEK/Risiko KEK + penyakit/komplikasi kehamilan → rujuk RS</strong>.</>,
            src: "Sumber: Juknis PMT Berbahan Pangan Lokal, Kemenkes RI 2025 (Kepdirjen No. 576)",
    ...
    return (
        <section id="pencegahan" className="py-16 px-6 lg:px-16 max-w-7xl mx-auto scroll-mt-20">
            <div className="w-full">
                <motion.div custom={0} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="mb-10">
                    <div className="flex items-center gap-3 text-[11px] font-bold tracking-widest uppercase text-[#e71d89] mb-3">
                        05 — Pencegahan & Tatalaksana<div className="flex-1 h-px bg-[#e71d89]/20"></div>
                    </div>
                    <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#1E293B] mb-3 tracking-tight">Apa yang Harus Dilakukan?</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    <div className="lg:col-span-7 relative">
                        ...
                        <div className="space-y-6 sm:space-y-8">
                            {steps.map((step, index) => (
                                <motion.div key={index} custom={0.1 + (index * 0.15)} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="relative z-10 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                                    <div className={`w-12 h-12 shrink-0 rounded-2xl flex items-center justify-center font-serif text-xl font-bold shadow-sm ${step.numColor}`}>{index + 1}</div>
                                    <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm flex-1 hover:border-[#e71d89]/40 transition-colors">
                                        ...
                                        <p className="text-[13.5px] text-slate-600 leading-[1.7] mb-4">{step.body}</p>
                                        <div className="text-[10.5px] font-bold text-slate-400 pt-3 border-t border-slate-100">{step.src}</div>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
                    ...
                    <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-28">
                        <motion.div custom={0.4} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="bg-[#1E293B] rounded-3xl p-6 lg:p-8 relative overflow-hidden shadow-lg">
                            <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-[#e71d89]/30 rounded-full blur-3xl pointer-events-none"></div>
                            <div className="relative z-10">
                                <div className="flex items-center gap-2 text-[10px] font-extrabold tracking-widest uppercase text-[#FFD1E8] mb-3"><Target size={14} /> Target Tambahan Asupan</div>
                                <h3 className="font-serif text-xl font-bold text-white mb-5 leading-tight">PMT Pangan Lokal Ibu Hamil KEK/Risiko KEK</h3>
                        ...
                        <motion.div custom={0.5} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="bg-[#FFF5F9] border border-[#e71d89]/20 rounded-3xl p-6 lg:p-8 shadow-sm">
                            <h4 className="font-serif text-lg font-bold text-[#c21470] mb-5 flex items-center gap-3">
                                <div className="w-8 h-8 rounded-lg bg-[#e71d89]/10 flex items-center justify-center"><Pill size={18} strokeWidth={2.5} /></div>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <>Konsumsi bersama <strong className="text-[#1E293B]">air jeruk / sumber vit. C</strong> untuk meningkatkan absorpsi</>,
                                    ...
                                    <div key={i} className="flex gap-3 items-start bg-white/60 border border-[#e71d89]/10 p-3.5 rounded-xl">
                                        ...
                                        <div className="text-[13px] text-slate-600 leading-relaxed">{txt}</div>
                                    </div>
                                ))}
                            </div>
                        </motion.div>
