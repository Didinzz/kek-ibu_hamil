            ...
            <section className="relative bg-[#FFF5F9] pt-24 pb-20 px-6 lg:px-12 text-center overflow-hidden border-b border-[#e71d89]/10">
                ...
                >
                    ...
                    <motion.h1 variants={heroItem} className="font-serif text-4xl md:text-5xl lg:text-6xl font-black text-[#1E293B] leading-tight mb-6">
                        Tabel Konversi <span className="text-[#e71d89]">Gizi</span><br />
                        <span className="text-[#c21470] italic font-serif">Bahan Makanan</span>
                    </motion.h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
                        <motion.div variants={heroCard} whileHover={{ y: -5 }} className="bg-white border border-[#e71d89]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm cursor-default">
                            ...
                            <h3 className="font-bold text-[#1E293B] text-sm mb-1">Mudah Ditukar</h3>
                            <p className="text-xs text-slate-500 text-center">Tukar bahan makanan dengan nutrisi yang setara.</p>
                        </motion.div>
                        ...
                        <motion.div variants={heroCard} whileHover={{ y: -5 }} className="bg-white border border-[#e71d89]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm cursor-default">
                            ...
                            <h3 className="font-bold text-[#1E293B] text-sm mb-1">Fokus Bumil</h3>
                            <p className="text-xs text-slate-500 text-center">Highlight khusus untuk Protein dan Zat Besi.</p>
                        </motion.div>
                        ...
                        <motion.div variants={heroCard} whileHover={{ y: -5 }} className="bg-white border border-[#e71d89]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm cursor-default">
                            ...
                            <h3 className="font-bold text-[#1E293B] text-sm mb-1">Standar Kemenkes</h3>
                            <p className="text-xs text-slate-500 text-center">Berdasarkan data akurat TKPI resmi pemerintah.</p>
                        </motion.div>
                    </div>
                </motion.div>
            </section>
                ...
                >
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 relative z-10">
                        <h2 className="font-serif text-3xl font-black text-[#1E293B] leading-tight">
                            Daftar Kandungan <span className="text-[#e71d89]">Per Porsi</span>
                        </h2>
                        ...
                        <div className="flex items-center gap-3 text-slate-500 text-xs bg-[#FFF5F9] border border-[#e71d89]/10 px-5 py-3 rounded-2xl">
                            ...
                            <span className="leading-relaxed font-medium">Sumber: Tabel Komposisi Pangan Indonesia (TKPI) - Kemenkes RI </span>
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto [scrollbar-width:thin] pb-24 relative">
                        <div className="min-w-[900px] relative">
                            ...
                            {/* HEADER KOLOM (Pink Theme) */}
                            <div className={`sticky top-4 z-40 grid ${gridCols} gap-4 bg-[#1E293B] text-white p-4 rounded-2xl mb-8 shadow-xl items-center border border-white/10`}>
                                <div className="text-center font-bold text-[11px] tracking-wider uppercase px-2">Bahan Makanan</div>
                                <div className="text-center font-bold text-[11px] tracking-wider uppercase px-2">Porsi</div>
                                <div className="text-center font-bold text-[11px] tracking-wider uppercase">Energi <span className="block text-[9px] opacity-60 normal-case font-normal">(kkal)</span></div>
                                <div className="text-center font-black text-[11px] tracking-wider uppercase text-[#FFD1E8] bg-white/10 py-2 rounded-lg mx-1">Protein <span className="block text-[9px] opacity-80 normal-case font-normal">(g)</span></div>
                                <div className="text-center font-bold text-[11px] tracking-wider uppercase">Lemak <span className="block text-[9px] opacity-60 normal-case font-normal">(g)</span></div>
                                <div className="text-center font-bold text-[11px] tracking-wider uppercase">Karbo <span className="block text-[9px] opacity-60 normal-case font-normal">(g)</span></div>
                                <div className="text-center font-black text-[11px] tracking-wider uppercase text-[#FFD1E8] bg-white/10 py-2 rounded-lg mx-1">Zat Besi <span className="block text-[9px] opacity-80 normal-case font-normal">(mg)</span></div>
                            </div>
                                    ...
                                    <div key={gIdx} className="relative">
                                        ...
                                        >
                                            {group.items.map((item, iIdx) => (
                                                ...
                                                >
                                                    <div className="font-bold text-[#1E293B] px-2">{item.nama}</div>
                                                    ...
                                                    {/* Highlight Protein (Pink Soft) */}
                                                    <div className="text-sm text-center font-black text-[#c21470] bg-[#FFF5F9] py-2 rounded-lg mx-1 group-hover:bg-white group-hover:shadow-sm transition-all border border-[#e71d89]/5">
                                                        {item.p}
                                                    </div>
                                                    ...
                                                    {/* Highlight Zat Besi (Magenta Soft) */}
                                                    <div className="text-sm text-center font-black text-[#e71d89] bg-[#FFF5F9] py-2 rounded-lg mx-1 group-hover:bg-white group-hover:shadow-sm transition-all border border-[#e71d89]/5">
                                                        {item.fe}
                                                    </div>
                                                </motion.div>
                                            ))}
